...
OWNER_NAME = getenv("OWNER_NAME", "SHIV")
OWNER_USERNAME = getenv("OWNER_USERNAME", "ll_SABKA_BHAI_KILLER_ll")
ALIVE_NAME = getenv("ALIVE_NAME", "Killer boy")
BOT_USERNAME = getenv("BOT_USERNAME", "Suchi_Robot")
OWNER_ID = getenv("OWNER_ID", "5505030156")
...
START_PIC = getenv("START_PIC", "https://telegra.ph/file/0bf6908dda6d5c8a116e9.jpg")
